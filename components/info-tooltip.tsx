...
export const tooltipDefinitions = {
  ...
  verificationLayer: "The Verification Layer provides third-party validation of component data, ensuring that technical properties, condition assessments, and safety parameters have been independently verified. CircuFax links to external verification providers like Circularise.",
  ...
  circularDecisionMaking: "Circular Decision-Making uses verified component data to evaluate reuse, repurposing, or material recovery options, supporting sustainable infrastructure practices across the supply chain."
}
